...
const PRECACHE = [
  ...
  './js/apps/gleam/ai.js',
  './js/apps/scarab/index.js',
  './js/apps/scarab/state.js',
  './js/apps/scarab/audio.js',
  './js/apps/scarab/engine.js',
  './js/apps/scarab/screens.js',
  './js/apps/scarab/levels.js',
  './js/apps/scarab/chunks.js',
